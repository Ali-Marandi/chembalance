...
سناریوها ضریب جذب مشتری جدید را در **تمام سه سال پیش‌بینی** تغییر می‌دهند؛ قیمت و هزینه در سناریوی پایه نگه داشته می‌شوند تا حساسیت تجاری پنهان نشود. بنابراین نقد پایان دوره، حاصل اثر تجمعی تفاوت درآمد در کل ۳۶ ماه است. این یک تحلیل محدود است و جایگزین مدل کامل headcount، قرارداد و جریان نقدی ماهانه نیست.

| سناریو | ضریب جذب مشتری | درآمد ۲۰۲۹E، دلار هزار | نقد پایان ۲۰۲۹E، دلار هزار | تفسیر |
|---|---:|---:|---:|---|
| Downside | ۷۰٪ | ۲۹۰٫۰ | ۹٫۰ | چرخهٔ فروش طولانی‌تر یا تبدیل کمتر از انتظار |
| Base | ۱۰۰٪ | ۴۱۴٫۲ | ۱۶۵٫۱ | برنامهٔ مدیریت؛ نیازمند اثبات در پایلوت‌ها |
| Upside | ۱۳۰٪ | ۵۳۸٫۴ | ۳۲۱٫۱ | کانال شریک یا تبدیل بهتر از انتظار |

در سناریوی downside، نقد پایان برنامه به ۹٫۰ هزار دلار می‌رسد؛ بنابراین تیم باید بسیار پیش‌تر از نزدیک‌شدن به این سطح، هزینه‌های اختیاری و سرعت استخدام را بازبینی کند. این مدل عمداً نشان می‌دهد که رشد درآمد به‌تنهایی جایگزین مدیریت هزینه نیست.
